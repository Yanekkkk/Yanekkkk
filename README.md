...
- 目前在做：一站式测试平台【用例编写与管理、UI自动化、接口自动化、性能测试、MockFactory】

### 🔨 技术栈
- 语言与框架：Python | Java | Fastapi | Vue | Locust | Pytest
- 工具与平台：GitHub | Docker | K8s | 自建测试平台

### ⭐️ 代表性项目
- [xxxxxx](xxxxxxx) — 从 0 到 1 搭建 AI 测试平台（43★）
